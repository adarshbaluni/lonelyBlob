...
public class Pointer : MonoBehaviour {
  ...
  public Transform ArrowOverGoal;
	...
	void Update(){
		...
		if(host.position.y < (ArrowOverGoal.position.y + 20.0f) && host.position.y > (ArrowOverGoal.position.y - 10.0f ) && host.position.x > (ArrowOverGoal.position.x - 10.0f ) && host.position.x > (ArrowOverGoal.position.x - 10.0f ) )
